...
class UnifiedNetwork_v2_noVis(nn.Module):

    def __init__(self):

        super(UnifiedNetwork_v2_noVis, self).__init__()
    ...
    def forward(self, x):
        ...
        return pred_hand_pose, pred_hand_conf, pred_object_pose, pred_object_conf


    def total_loss(self, pred, true):

        pred_hand_pose, pred_hand_conf, pred_object_pose, pred_object_conf = pred
...
class UnifiedNetwork_v2_noExtra(nn.Module):

    def __init__(self):

        super(UnifiedNetwork_v2_noExtra, self).__init__()
