...
if __name__ == '__main__':
    ...
    load_FCN_name = '../models/FCN_1006_res34_muldataset_x10_vis.pth'
    ...
    testing_dataset_HO3D = HO3D_v2_Dataset_update(mode='test', cfg='test', loadit=True, augment=False, extra=True)
    ...
    """
    dataset 변경 후 gt joint value check 후 self.coord_change_mat 확인.
    """
    ...
    if flag_res34:
        ...
        if flag_lowerdim:
            model = UnifiedNetwork_v2_lowerdim()
